...
**Что это**  
Статусная страница проекта: где находится продукт сейчас и какие крупные блоки ещё доводятся.

**Для кого**  
Для автора проекта, научного руководителя и читателя, которому нужна текущая стадия работ, а не инструкция по запуску.

**Статус**  
Status-page. Здесь допустимы roadmap и незавершённые направления.

**Проверено по**  
`docs/definition-of-done-mvp.md`, `docs/tasks.md`, текущий продуктовый слой `docs/`
