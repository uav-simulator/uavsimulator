...
**Результат.** Обучение на процедурно генерируемых maze стало возможным с корректным reward'ом (см. § 9, rev37).
