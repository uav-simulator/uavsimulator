...
**Что это**  
Поддерживаемые способы установки и первого запуска проекта на текущем этапе разработки.

**Для кого**  
Для разработчика и пользователя, который поднимает проект из репозитория или работает с локально собранным runtime.

**Статус**  
Практическая инструкция по текущему состоянию проекта. Полноценного end-user инсталлятора у проекта пока нет.

**Проверено по**  
`README.md`, `python/sim_client/cli.py`, `.github/workflows/ci.yml`, `.github/workflows/release-manifest.yml`, `.github/workflows/release-rusim.yml`
