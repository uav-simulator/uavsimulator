...
zip_path = Path('python/training/artifacts/cardboard-corridor-ppo-v9-rev37/1.0.0/cardboard-corridor-ppo-v9-rev37_sb3.zip')
out_path = Path('python/training/artifacts/cardboard-corridor-ppo-v9-rev37/1.0.0/cardboard-corridor-ppo-v9-rev37.onnx')
