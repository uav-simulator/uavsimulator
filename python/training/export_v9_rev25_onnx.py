...
zip_path = Path('python/training/artifacts/cardboard-corridor-ppo-v9-rev25/1.0.0/cardboard-corridor-ppo-v9-rev25_sb3.zip')
out_path = Path('python/training/artifacts/cardboard-corridor-ppo-v9-rev25/1.0.0/cardboard-corridor-ppo-v9-rev25.onnx')
...
torch.onnx.export(w, (dummy_img, dummy_ultra), str(out_path),
