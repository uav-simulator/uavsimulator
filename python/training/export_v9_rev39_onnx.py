...
zip_path = Path('python/training/artifacts/cardboard-corridor-ppo-v9-rev39/1.0.0/cardboard-corridor-ppo-v9-rev39_sb3.zip')
out_path = Path('python/training/artifacts/cardboard-corridor-ppo-v9-rev39/1.0.0/cardboard-corridor-ppo-v9-rev39.onnx')
